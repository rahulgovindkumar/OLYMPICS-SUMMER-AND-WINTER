...
#Govinda Satyanarayana Bandaru
    ...
    country_df = processModule.medal_count_yearWise(temp_df, selected_country)
...
#Revanth Seethamraju
    ...
    name_summer = []
    name_winter = []
    famous_sports_summer = ['Basketball', 'Football', 'Tug-Of-War', 'Athletics',
                     'Swimming', 'Badminton', 'Sailing', 'Gymnastics',
                     'Art Competitions', 'Handball',
                     'Water Polo', 'Hockey', 'Rowing', 'Fencing',
                     'Shooting', 'Boxing', 'Weightlifting', 'Wrestling',
                     'Tennis', 'Golf', 'Softball', 'Judo', 'Archery',
                     'Volleyball', 'Synchronized Swimming', 'Table Tennis', 'Baseball',
                     'Rhythmic Gymnastics', 'Taekwondo', 'Cycling', 'Diving', 'Canoeing',
                     'Beach Volleyball', 'Triathlon', 'Rugby', 'Polo', 'Ice Hockey','Rugby Sevens']
